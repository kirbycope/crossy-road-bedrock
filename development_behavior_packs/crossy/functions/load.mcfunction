...
# (After 3 seconds) If "initialized" is 0, then run the world initialization script
execute if score world timer3 matches 1 run execute if score initialized world matches 0 run function init-world
